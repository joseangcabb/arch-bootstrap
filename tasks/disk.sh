...
# Create partitions
sgdisk /dev/sda --new=1:0:+$1 --typecode=1:ef00 --change-name=1:EF_System
sgdisk /dev/sda --new=2:0:+$2 --typecode=2:8300 --change-name=2:Root_Filesystem
sgdisk /dev/sda --new=3:0:+$3 --typecode=3:8200 --change-name=3:Swap_Space
